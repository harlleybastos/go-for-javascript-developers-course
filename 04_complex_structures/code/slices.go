...
func main() {
	fruitArray := [3]string{"Apple", "Orange", "Banana"}

	splicedFruitArray := fruitArray[1:3]

	fruitToAdd := append(splicedFruitArray, "Kiwi", "Pineapple")

	fmt.Println(splicedFruitArray, fruitToAdd)
